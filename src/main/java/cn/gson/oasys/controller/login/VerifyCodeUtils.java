...
//	}
	public static void outputImage(int w, int h, OutputStream os, String code) throws IOException {
		...
		//生成一张图片
		BufferedImage image = new BufferedImage(65, 25, BufferedImage.TYPE_INT_RGB);    // 实例化BufferedImage
		//获取一根笔对象
